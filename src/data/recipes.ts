// Recipe System - Centralized Definitions
import { ModuleType, Rarity } from '../types';
...
export const RECIPE_DEFINITIONS: Recipe[] = [
  ...
  // Round 6 new recipes
  {
    id: 'recipe-resonance-chamber',
    name: 'Resonance Chamber',
    description: 'Harmonizes energy frequencies through acoustic chambers filled with crystallized mana.',
    moduleType: 'resonance-chamber',
    rarity: 'uncommon',
    unlockCondition: {
      type: 'machines_created',
      value: 3,
      description: 'Create 3 unique machines',
    },
    hint: 'Forge 3 machines to discover the resonance chamber',
  },
  {
    id: 'recipe-fire-crystal',
    name: 'Fire Crystal',
    description: 'Channeling crystal infused with primordial flame essence for thermal energy conversion.',
    moduleType: 'fire-crystal',
    rarity: 'uncommon',
    unlockCondition: {
      type: 'activation_count',
      value: 10,
      description: 'Activate machines 10 times',
    },
    hint: 'Activate machines frequently to unlock fire crystals',
  },
  {
    id: 'recipe-lightning-conductor',
    name: 'Lightning Conductor',
    description: 'Captures and stabilizes ambient electrical discharges for controlled energy release.',
